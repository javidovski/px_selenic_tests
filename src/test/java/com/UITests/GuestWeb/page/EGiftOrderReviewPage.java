...
public class EGiftOrderReviewPage {

	@FindBy(id = "billing_info")
	private WebElement billingInfo;

	@FindBy(xpath = "/descendant::div[@class='well'][1]")
	private WebElement webElement;

	@FindBy(id = "billing_info")
	private WebElement billingInfoField;

	@FindBy(xpath = "(//input[@value='Submit Order'])[2]")
	...
	private static final String[] TITLE_WORDS = { "Order", "Review" };

	public EGiftOrderReviewPage(WebDriver driver) {
		this.driver = driver;
	...
	public String getBillingInfoFieldText() {
		return waitFor(billingInfoField).getText();
	}
