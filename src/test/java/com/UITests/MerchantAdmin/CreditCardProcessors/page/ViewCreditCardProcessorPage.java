...
public class ViewCreditCardProcessorPage {
	...
	private static final String[] TITLE_WORDS = { "View", "Credit", "Card", "Processor" };

	public ViewCreditCardProcessorPage(WebDriver driver) {
		this.driver = driver;
